...
cd E:\GitCode\Vigra_Test\build\test\seededRegionGrowing3d

cmd /c "E:\GitCode\Vigra_Test\build\test\seededRegionGrowing3d\%CONFIGURATION%\test_seededRegionGrowing3d.exe"
IF %ERRORLEVEL% NEQ 0 (
